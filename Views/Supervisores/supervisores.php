...
<main class="app-content">
    <div class="app-title">
        <div>
            <h1>
                <i class="fas fa-user-tie"></i> <?= NOMBRE_WEB . ' - ' . $data['page_title'] ?> &nbsp;&nbsp;
                <div class="btn-group" role="group">
                    <div class="btn-group" role="group">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a class="dropdown-item" onclick="generarReportSupervisors()"><i class="fas fa-file-pdf"></i>&nbsp;&nbsp;Generar Reporte</a>
                        </div>
                    </div>
                </div>
            </h1>
            ...
            <div class="tile">
                <div class="tile-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-responsive-lg" id="tableSupervisors" style="width:100%">
                            <thead>
                                <tr>
                                    <th>Rut</th>
                                    <th>Nombre</th>
