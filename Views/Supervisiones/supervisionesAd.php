...
<main class="app-content">
    <div class="app-title">
                ...
                <div class="btn-group" role="group">
                    <div class="btn-group" role="group">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item" onclick="generarReportSupervicions()"><i class="fas fa-file-pdf"></i>&nbsp;&nbsp;Generar Reporte</a>
                        </div>
                    </div>
                </div>
            </h1>
        ...
        <ul class="app-breadcrumb breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?= base_url(); ?>/supervisiones/supervisionesAd"><?= $data['page_title'] ?></a></li>
        </ul>
    </div>
    <div class="row">
        <div class="col-md-12">
